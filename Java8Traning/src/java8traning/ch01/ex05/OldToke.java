 ...
 */
package java8traning.ch01.ex05;
...
public class OldToke extends Frame implements ActionListener {
	private static final long serialVersionUID = 1L;
	private PropetyDialog2 propertyDialog;
	private double resize = 1.0;

	public static void main(String args[]) {

		OldToke app = new OldToke("");
	...
	public OldToke(String title) {
		super(title);
		propertyDialog = new PropetyDialog2(this);
		generateMenu();
	...
	public void startClock(OldToke clock) {
		while (true) {
			try {
				Thread.sleep(1);
				clock.repaint();
...
class PropetyDialog2 extends Dialog implements ActionListener {
	/**
	 *
	 */
	private static final long serialVersionUID = 1L;
	...
	public PropetyDialog2(Frame owner) {
		super(owner);
		ClockMain = owner;
		setSize(400, 200);
		setResizable(false);
