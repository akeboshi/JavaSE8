...
public class Tokei extends Frame {
	...
	public void startClock(Tokei clock) {
		while (true) {
			try {
				Thread.sleep(1);
				clock.repaint();
	...
	public void generateMenu() {
		...
		// イベントリスクの設定
		newm.addActionListener((e) -> propertyDialog.viewProperty());
		closem.addActionListener((e) -> System.exit(0));
...
class PropetyDialog extends Dialog {
	/**
	 *
	 */
	private static final long serialVersionUID = 1L;
